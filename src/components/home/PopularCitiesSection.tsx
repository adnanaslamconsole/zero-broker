          ...
          {popularCities.map((city, index) => (
            ...
            >
              <Link
                ...
                className="group relative block aspect-[4/3] rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow"
              >
                <img
                ...
                <div className="absolute bottom-3 left-3 sm:bottom-4 sm:left-4 right-3 sm:right-4">
                  <h3 className="text-base sm:text-xl font-semibold text-white truncate">{city.name}</h3>
                  <p className="flex items-center gap-1 sm:gap-1.5 text-[10px] sm:text-sm text-white/80 mt-0.5 sm:mt-1">
