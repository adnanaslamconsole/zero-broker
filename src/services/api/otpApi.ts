...
const API_BASE_URL = import.meta.env.VITE_OTP_API_URL || 'http://localhost:3000/api';
...
export const otpApi = {
     ...
     */
    async verifyOtp(phoneNumber: string, otp: string): Promise<{ message: string; verified: boolean }> {
        try {
