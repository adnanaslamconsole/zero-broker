-- Update get_properties_prioritized to prioritize verified owners
...
BEGIN
  ...
  WITH filtered_data AS (
    SELECT 
      p.*,
      prof.kyc_status as prof_kyc_status,
      prof.trust_score as prof_trust_score,
  ...
  ORDER BY 
    CASE 
      WHEN fd.prof_kyc_status = 'verified' THEN 0 
      ELSE 1 
    END, -- Prioritize verified owners
    CASE 
